...
const INITIAL_STAKE_MULTIPLE = new BN(10).pow(new BN(6)); // 100 SPAD -> 100M SPAD-S
...
describe('Pool', function () {
  ...
  beforeEach(async function () {
    ...
    this.dollar = await MockToken.new("Space Dollar", "SPAD", 18, {from: ownerAddress, gas: 8000000});
